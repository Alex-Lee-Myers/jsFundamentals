...
let complexArrLiteral = [1, true, 'Academy', [1,2,3],  {key: 'test'}, function(){return 'yes'}]; //anonymous function at end. function without a name.
//                       0   1       2           3            4               5
...
console.log(complexObjLiteral.func); //func
console.log(complexObjLiteral.arr); // [1,2,3]
