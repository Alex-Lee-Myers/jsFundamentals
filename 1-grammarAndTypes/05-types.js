...
/*
Null and undefined both represent variables with no value inside. Think of it this way--null values are for gag gifts that are boxes intentially given with nothing inside (because that's that gas.)
...
//strong concatenation vs addition
...
console.log(third); //1050abcde
console.log(typeof third); //string (typeof lets you know that)

//Interpolation
//lets you use strings with dynamic content (they require backticks) (tilda key thing)
//`${variable} STRING` best way to write string
//Example 1:
let age = 32;
...
Object is a parent of an array. 
Denoted by {}
...
console.log(hulk);
console.log(hulk.age); //only grabs age ex: hulk.color would get green. console.log(typeofhulk) 
...
console.log(stepsToBrushTeeth[0]); //give 0 position and you get uncap toothpaste, 5 would be undefined
console.log(typeof stepsToBrushTeeth); //will say object, not array. 